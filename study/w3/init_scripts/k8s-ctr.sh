...
curl --silent -o /root/kubeadm-init-ctr-config.yaml https://raw.githubusercontent.com/iamjjanga-ouo/cilium-lab/refs/heads/main/study/w3/kubeadm-configs/kubeadm-init-ctr-config.yaml
